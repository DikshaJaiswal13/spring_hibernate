...
<form:form method="post" action="${action}" commandName="customer" cssClass="customerForm">
	...
	<tr>
		<td>
			<form:label path="id" cssClass="customerLabel"><!--for internationalization  -->
				<spring:message code="label.customerId" /><!--for internationalization refer messages_en.properties file -->
			</form:label>
		</td>
		<td>
